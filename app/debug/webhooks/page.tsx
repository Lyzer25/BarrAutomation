          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-red-500">{healthData?.metrics.successRate.toFixed(1) || "0"}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-purple-500">{healthData?.metrics.averageResponseTime || 0}ms</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-green-500">{healthData?.metrics.totalRequests || 0}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <ScrollArea className="h-96">
            <div className="space-y-2">
                    ...
                    <Card className={`${log.success ? "border-green-500/20" : "border-red-500/20"}`}>
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <Badge variant={log.success ? "default" : "destructive"}>{log.responseStatus}</Badge>
                            <Badge variant="outline">{log.processingTime}ms</Badge>
                          </div>
                        </div>
                        {log.error && (
                          <div className="mt-2 p-2 bg-red-500/10 rounded text-sm text-red-400">{log.error}</div>
                        )}
                      </CardContent>
                    </Card>
                  </motion.div>
              ...
              {!healthData?.recentActivity.recentLogs.length && (
                <div className="text-center py-8 text-muted-foreground">No webhook activity recorded yet</div>
              )}
            </div>
          </ScrollArea>
        </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                {testResult ? (
                  ...
                  <div className="text-center py-8 text-muted-foreground">Send a test request to see the response</div>
                )}
              </CardContent>
            </Card>
          </div>
