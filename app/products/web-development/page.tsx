...
export default function WebDevelopmentPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      <section
        ref={heroRef}
        className="relative container mx-auto px-4 pt-32 pb-20 overflow-hidden min-h-screen flex flex-col justify-center"
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/80 font-light leading-relaxed max-w-2xl mx-auto mb-8">
